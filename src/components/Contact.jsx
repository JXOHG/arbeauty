  ...
  return (
    <section id="contact" className="py-16 md:py-20 bg-gray-100">
      <div className="container mx-auto px-4">
        <h2 className="text-2xl md:text-3xl font-bold mb-8 text-center">{t("contact.title")}</h2>
        <div className="flex flex-col md:flex-row gap-8">
          <div className="md:w-1/2">
            <h3 className="text-xl md:text-2xl font-semibold mb-4">{t("contact.getInTouch")}</h3>
            <p className="mb-4">{t("contact.reachOut")}</p>
            <div className="space-y-2">
              <p>
                <strong>{t("contact.email")}:</strong> arbeauty2309@gmail.com
              </p>
              <p>
              ...
              <p>
                <strong>KakaoTalk:</strong> arbeauty2309
              </p>
              <div className="flex items-center space-x-4 mt-4">
                <a
                  href="https://www.instagram.com/arbeauty2309"
                  target="_blank"
                ...
                <a
                  href="http://qr.kakao.com/talk/4Rtne7MaI3qby8p5eprZNyvFJ5w-"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="text-2xl text-black hover:text-gray-700"
                >
            ...
            <div className="mt-8">
              ...
              <img src={qr || "/placeholder.svg"} alt="KakaoTalk QR Code" className="w-32 h-32 md:w-40 md:h-40" />
            </div>
          </div>
          <div className="md:w-1/2">
            <h3 className="text-xl md:text-2xl font-semibold mb-4">{t("contact.sendMessage")}</h3>
